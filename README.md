...
* **Welke content, en welke HTML heb ik nodig?**
  ...
  **Lars:** Qua html heb ik voornamelijk afbeeldingen nodig en tekst. HTML is meer de basis voor je dingen waar je je juiste layout maakt en bij css maak je het juist mooier. Ook maak je hier je knoppen/links voor volgende pagina’s
...
<img width="4000" height="3000" alt="20260916_103206" src="https://github.com/user-attachments/assets/0d49fac8-641d-4eb0-909f-cf8479589aaa" />
...
Duidelijkheid, leuke vormgeving en goeie hirarhie (en voor mij simpelheid)
...
Ik zit eraan te denken om iets met voetbal of formule 1 te doen, gezien deze 2 sporten veel voor mij hebben betekent, en ik er veel vanaf weet sinds een klein jongetje.
### 4 sept - [Workshop]
...
De hosting is een bedrijf die je link/adress online houdt en ervoor zorgt dat je niet thuis een server hoeft te draaien dus in ons geval transip
Vertel welke domeinnaam jij gekozen hebt en hoe je die hebt gekoppeld aan jouw pagina.
larsss.nl en dat heb ik gekozen, en dan heb ik dat via git gedaan en dat via source control. En de DNS gekoppelt
Beschrijf hoe je aanpassingen aan jouw pagina kunt maken en hoe je er voor zorgt dat die op het web gepubliceerd worden.
in de .html aanpassingen maken css html en dan control s klikken. denk ik dan teminste
